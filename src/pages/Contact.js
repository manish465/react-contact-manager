...
const Contact = () => {
    ...
    return (
        <section id="profile">
            ...
            <h3>
                <span>email : </span>
                <span>{contact ? contact.email : "feching....."}</span>
            </h3>
            <h3>
                <span>company name : </span>
                <span>
                    {contact ? contact.work.companyName : "feching....."}
                </span>
            </h3>
            <h3>
                <span>job designation : </span>
                <span>
                    {contact ? contact.work.jobDesignation : "feching....."}
                </span>
            </h3>
            {contact.phoneNumbers.map((phoneNumber, key) => (
                <div key={key}>
                    <h3>
                        ...
                        <span>
                            {contact ? phoneNumber.countryCode : "feching....."}
                        </span>
                    </h3>
                    <h3>
                        <span>number : </span>
            ...
            <h3>
                <span>country code : </span>
                <span>{contact ? contact.description : "feching....."}</span>
            </h3>
